...
var pathArg = (path5, opt = {}) => {
  ...
  path5 = (0, import_path2.resolve)(path5);
  const { root } = (0, import_path2.parse)(path5);
  ...
  if (platform_default === "win32") {
    const badWinChars = /[*|"<>?:]/;
    const { root: root2 } = (0, import_path2.parse)(path5);
...
var readdirSync2 = (path5) => (0, import_fs4.readdirSync)(path5, { withFileTypes: true });
var chmod = (path5, mode) => new Promise((res, rej) => import_fs2.default.chmod(path5, mode, (er, ...d) => er ? rej(er) : res(...d)));
var mkdir = (path5, options) => new Promise((res, rej) => import_fs2.default.mkdir(path5, options, (er, made) => er ? rej(er) : res(made)));
var readdir2 = (path5) => new Promise((res, rej) => import_fs2.default.readdir(path5, { withFileTypes: true }, (er, data) => er ? rej(er) : res(data)));
var rename = (oldPath, newPath) => new Promise((res, rej) => import_fs2.default.rename(oldPath, newPath, (er, ...d) => er ? rej(er) : res(...d)));
var rm = (path5, options) => new Promise((res, rej) => import_fs2.default.rm(path5, options, (er, ...d) => er ? rej(er) : res(...d)));
var rmdir = (path5) => new Promise((res, rej) => import_fs2.default.rmdir(path5, (er, ...d) => er ? rej(er) : res(...d)));
var stat = (path5) => new Promise((res, rej) => import_fs2.default.stat(path5, (er, data) => er ? rej(er) : res(data)));
var lstat2 = (path5) => new Promise((res, rej) => import_fs2.default.lstat(path5, (er, data) => er ? rej(er) : res(data)));
var unlink = (path5) => new Promise((res, rej) => import_fs2.default.unlink(path5, (er, ...d) => er ? rej(er) : res(...d)));
var promises = {
  chmod,
  mkdir,
  readdir: readdir2,
...
var rimrafPosixSync = (path5, opt) => {
  ...
  try {
    return rimrafPosixDirSync(path5, opt, (0, import_fs3.lstatSync)(path5));
  } catch (er) {
    if ((er == null ? void 0 : er.code) === "ENOENT")
      return true;
    throw er;
...
var rimrafPosixDir = async (path5, opt, ent) => {
  ...
  const removedAll = (await Promise.all(entries.map((ent2) => rimrafPosixDir((0, import_path3.resolve)(path5, ent2.name), opt, ent2)))).reduce((a, b) => a && b, true);
  if (!removedAll) {
    return false;
  }
  if (opt.preserveRoot === false && path5 === (0, import_path3.parse)(path5).root) {
    return false;
  }
  if (opt.filter && !await opt.filter(path5, ent)) {
    return false;
...
var rimrafPosixDirSync = (path5, opt, ent) => {
  ...
  if (!Array.isArray(entries)) {
    ...
    ignoreENOENTSync(() => (0, import_fs3.unlinkSync)(path5));
    return true;
  }
  let removedAll = true;
  for (const ent2 of entries) {
    const p = (0, import_path3.resolve)(path5, ent2.name);
  ...
  ignoreENOENTSync(() => (0, import_fs3.rmdirSync)(path5));
  return true;
};
...
var fixEPERMSync = (fn) => (path5) => {
  try {
    ...
    if ((fer == null ? void 0 : fer.code) === "EPERM") {
      try {
        (0, import_fs3.chmodSync)(path5, 438);
      } catch (er2) {
        const fer2 = er2;
        if ((fer2 == null ? void 0 : fer2.code) === "ENOENT") {
          return;
...
var isDirSync = (path5) => {
  try {
    return (0, import_fs3.statSync)(path5).isDirectory();
  } catch (er) {
    return false;
  }
};
...
var win32DefaultTmp = async (path5) => {
  const { root } = (0, import_path4.parse)(path5);
...
var uniqueFilename = (path5) => `.${(0, import_path5.basename)(path5)}.${Math.random()}`;
...
var unlinkFixEPERMSync = (path5) => {
  try {
    (0, import_fs3.unlinkSync)(path5);
  } catch (er) {
    if ((er == null ? void 0 : er.code) === "EPERM") {
      try {
        return (0, import_fs3.chmodSync)(path5, 438);
      } catch (er2) {
...
var rimrafMoveRemoveDir = async (path5, opt, ent) => {
  ...
  if (path5 === opt.tmp && (0, import_path5.parse)(path5).root !== path5) {
  ...
  const removedAll = (await Promise.all(entries.map((ent2) => rimrafMoveRemoveDir((0, import_path5.resolve)(path5, ent2.name), opt, ent2)))).reduce((a, b) => a && b, true);
  if (!removedAll) {
    return false;
  }
...
var tmpUnlink = async (path5, tmp, rm3) => {
  const tmpFile = (0, import_path5.resolve)(tmp, uniqueFilename(path5));
...
var rimrafMoveRemoveSync = (path5, opt) => {
  ...
  try {
    return rimrafMoveRemoveDirSync(path5, opt, (0, import_fs3.lstatSync)(path5));
  } catch (er) {
    if ((er == null ? void 0 : er.code) === "ENOENT")
      return true;
    throw er;
...
var rimrafMoveRemoveDirSync = (path5, opt, ent) => {
  ...
  ignoreENOENTSync(() => tmpUnlinkSync(path5, tmp, import_fs3.rmdirSync));
  return true;
};
var tmpUnlinkSync = (path5, tmp, rmSync2) => {
  const tmpFile = (0, import_path5.resolve)(tmp, uniqueFilename(path5));
  (0, import_fs3.renameSync)(path5, tmpFile);
...
var rimrafWindowsSync = (path5, opt) => {
  ...
  try {
    return rimrafWindowsDirSync(path5, opt, (0, import_fs3.lstatSync)(path5), START);
  } catch (er) {
    if ((er == null ? void 0 : er.code) === "ENOENT")
      return true;
    throw er;
...
var rimrafWindowsDir = async (path5, opt, ent, state = START) => {
  ...
  const removedAll = (await Promise.all(entries.map((ent2) => rimrafWindowsDir((0, import_path6.resolve)(path5, ent2.name), opt, ent2, s)))).reduce((a, b) => a && b, true);
  if (state === START) {
...
function getPackageVersion(name) {
  const rootDir = import_path7.default.resolve(import_path7.default.dirname(__filename), "..");
  const filePath = import_path7.default.join(rootDir, "pyproject.toml");
  const fileStr = import_fs12.default.readFileSync(filePath);
...
async function register6(context, client2) {
  await client2.onReady();
  context.subscriptions.push(
    import_coc9.commands.registerCommand("ruff.showOutput", () => {
...
async function register7(client2) {
  await client2.onReady();
  if (!import_coc10.workspace.getConfiguration("ruff").get("autoFixOnSave", false))
    return;
  import_coc10.workspace.registerAutocmd({
    ...
    callback: async () => {
      ...
      if (existsFix) {
        await import_coc10.workspace.nvim.call("CocAction", ["runCommand", "ruff.executeAutofix"]);
      }
    }
  });
}
...
async function register8(context, client2) {
  await client2.onReady();
  if (!import_coc11.workspace.getConfiguration("ruff").get("client.codeAction.showDocumantaion.enable", false))
    return;
  const documentSelector = [{ scheme: "file", language: "python" }];
  context.subscriptions.push(
    import_coc11.languages.registerCodeActionProvider(documentSelector, new ShowDocumentationCodeActionProvider(client2), "ruff")
  );
}
var ShowDocumentationCodeActionProvider = class {
  ...
  async provideCodeActions(document, range, context) {
    ...
    const wholeRange = import_coc11.Range.create(0, 0, doc.lineCount, 0);
    let whole = false;
...
async function activate(context) {
  if (!import_coc12.workspace.getConfiguration("ruff").get("enable"))
    return;
  ...
  if (!ruffLspPath || !import_fs14.default.existsSync(ruffLspPath)) {
    ...
    import_coc12.window.showWarningMessage(
